...
import { GetCustomerServiceStatsDto } from '../type';
import {
...
export class GetCustomerServiceStatsValidator {
  ...
  public validate(query: GetCustomerServiceStatsDto, location: string) {
